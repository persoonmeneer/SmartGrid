...
class SmartGrid(mesa.Model):
    def __init__(self, district: int) -> None:
        ...
        # house_1 = House(2002, self, 10, 20, 100)
        # house_2 = House(2002, self, 20, 23, 100)

        # self.houses = [house_1, house_2]

        # self.grid.place_agent(house_1, (10, 20))
        # self.grid.place_agent(house_2, (20, 23))

        # battery = Battery(2424, self, 13, 14, 2000)
        # battery_2 = Battery(2274, self, 12, 23, 0)
        # self.batteries = [battery, battery_2]

        # self.grid.place_agent(battery, (13, 14))
        # self.grid.place_agent(battery_2, (10, 16))
